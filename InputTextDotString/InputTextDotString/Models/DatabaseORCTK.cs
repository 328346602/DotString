...
{
    public class DatabaseORCTK
    {
        public new OracleConnection Conn = new OracleConnection();

        public DatabaseORCTK()
        {
            //测试方法
            string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["TK_CONN"].ToString();
            //中地使用方法
            //string connStr = System.Configuration.ConfigurationManager.AppSettings["connectionString"].ToString();
            Conn = new OracleConnection(connStr);
        }

        public DatabaseORCTK(string constr)
        {
